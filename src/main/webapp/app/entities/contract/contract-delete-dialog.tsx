...
export const ContractDeleteDialog = (props: RouteComponentProps<{ id: string }>) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="moiInstallmentApplicationApp.contract.delete.question">
        <Translate contentKey="moiInstallmentApplicationApp.contract.delete.question" interpolate={{ id: contractEntity.id }}>
