...
export const CustomerDeleteDialog = (props: RouteComponentProps<{ id: string }>) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="moiInstallmentApplicationApp.customer.delete.question">
        <Translate contentKey="moiInstallmentApplicationApp.customer.delete.question" interpolate={{ id: customerEntity.id }}>
