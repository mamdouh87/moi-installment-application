...
import ae.isoft.moi.installment.repository.CountryRepository;
import ae.isoft.moi.installment.service.dto.CountryDTO;
import ae.isoft.moi.installment.service.mapper.CountryMapper;
...
class CountryResourceIT {
    ...
    public static Country createEntity(EntityManager em) {
        Country country = new Country().code(DEFAULT_CODE).nameAr(DEFAULT_NAME_AR).nameEn(DEFAULT_NAME_EN);
        return country;
    }
    ...
    public static Country createUpdatedEntity(EntityManager em) {
        Country country = new Country().code(UPDATED_CODE).nameAr(UPDATED_NAME_AR).nameEn(UPDATED_NAME_EN);
        return country;
    }
    ...
    void putNewCountry() throws Exception {
        ...
        updatedCountry.code(UPDATED_CODE).nameAr(UPDATED_NAME_AR).nameEn(UPDATED_NAME_EN);
    ...
    void partialUpdateCountryWithPatch() throws Exception {
        ...
        partialUpdatedCountry.code(UPDATED_CODE).nameAr(UPDATED_NAME_AR).nameEn(UPDATED_NAME_EN);
