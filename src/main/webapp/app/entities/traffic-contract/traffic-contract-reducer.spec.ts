...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_TRAFFICCONTRACT_LIST actions', async () => {
    ...
    it('dispatches FETCH_TRAFFICCONTRACT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_TRAFFICCONTRACT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_TRAFFICCONTRACT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_TRAFFICCONTRACT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_TRAFFICCONTRACT actions', async () => {
      const expectedActions = [
        {
