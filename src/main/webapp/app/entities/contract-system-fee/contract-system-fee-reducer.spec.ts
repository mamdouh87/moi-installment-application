...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './contract-system-fee.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_CONTRACTSYSTEMFEE_LIST actions', async () => {
    ...
    it('dispatches FETCH_CONTRACTSYSTEMFEE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_CONTRACTSYSTEMFEE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_CONTRACTSYSTEMFEE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_CONTRACTSYSTEMFEE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_CONTRACTSYSTEMFEE actions', async () => {
      const expectedActions = [
        {
