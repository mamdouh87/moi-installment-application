...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './installments-plan.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_INSTALLMENTSPLAN_LIST actions', async () => {
    ...
    it('dispatches FETCH_INSTALLMENTSPLAN actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_INSTALLMENTSPLAN actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_INSTALLMENTSPLAN actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_INSTALLMENTSPLAN actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_INSTALLMENTSPLAN actions', async () => {
      const expectedActions = [
        {
