...
export const CountryDeleteDialog = (props: RouteComponentProps<{ id: string }>) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="moiInstallmentApplicationApp.country.delete.question">
        <Translate contentKey="moiInstallmentApplicationApp.country.delete.question" interpolate={{ id: countryEntity.id }}>
