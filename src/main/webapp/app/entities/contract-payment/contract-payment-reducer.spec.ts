...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_CONTRACTPAYMENT_LIST actions', async () => {
    ...
    it('dispatches FETCH_CONTRACTPAYMENT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_CONTRACTPAYMENT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_CONTRACTPAYMENT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_CONTRACTPAYMENT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_CONTRACTPAYMENT actions', async () => {
      const expectedActions = [
        {
