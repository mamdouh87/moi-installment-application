...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './contract-system-fee-details.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_CONTRACTSYSTEMFEEDETAILS_LIST actions', async () => {
    ...
    it('dispatches FETCH_CONTRACTSYSTEMFEEDETAILS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_CONTRACTSYSTEMFEEDETAILS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_CONTRACTSYSTEMFEEDETAILS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_CONTRACTSYSTEMFEEDETAILS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_CONTRACTSYSTEMFEEDETAILS actions', async () => {
      const expectedActions = [
        {
