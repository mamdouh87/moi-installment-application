...
export const RequestDeleteDialog = (props: RouteComponentProps<{ id: string }>) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="moiInstallmentApplicationApp.request.delete.question">
        <Translate contentKey="moiInstallmentApplicationApp.request.delete.question" interpolate={{ id: requestEntity.id }}>
