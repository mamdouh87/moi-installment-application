  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="moiInstallmentApplicationApp.country.home.createOrEditLabel" data-cy="CountryCreateUpdateHeading">
            <Translate contentKey="moiInstallmentApplicationApp.country.home.createOrEditLabel">Create or edit a Country</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('moiInstallmentApplicationApp.country.code')}
                id="country-code"
                name="code"
                data-cy="code"
                type="text"
              />
              <ValidatedField
                label={translate('moiInstallmentApplicationApp.country.nameAr')}
                id="country-nameAr"
                name="nameAr"
                data-cy="nameAr"
                type="text"
              />
              <ValidatedField
                label={translate('moiInstallmentApplicationApp.country.nameEn')}
                id="country-nameEn"
                name="nameEn"
                data-cy="nameEn"
                type="text"
