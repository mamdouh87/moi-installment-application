...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './request-system-fee-details.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_REQUESTSYSTEMFEEDETAILS_LIST actions', async () => {
    ...
    it('dispatches FETCH_REQUESTSYSTEMFEEDETAILS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_REQUESTSYSTEMFEEDETAILS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_REQUESTSYSTEMFEEDETAILS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_REQUESTSYSTEMFEEDETAILS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_REQUESTSYSTEMFEEDETAILS actions', async () => {
      const expectedActions = [
        {
