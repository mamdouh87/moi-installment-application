...
import ae.isoft.moi.installment.repository.CustomerRepository;
import ae.isoft.moi.installment.service.dto.CustomerDTO;
import ae.isoft.moi.installment.service.mapper.CustomerMapper;
...
class CustomerResourceIT {
    ...
    void createCustomer() throws Exception {
        ...
        assertThat(testCustomer.getPassportNo()).isEqualTo(DEFAULT_PASSPORT_NO);
        assertThat(testCustomer.getCountryId()).isEqualTo(DEFAULT_COUNTRY_ID);
        ...
        assertThat(testCustomer.getTradeLicense()).isEqualTo(DEFAULT_TRADE_LICENSE);
    }
    ...
    void putNewCustomer() throws Exception {
        ...
        assertThat(testCustomer.getPassportNo()).isEqualTo(UPDATED_PASSPORT_NO);
        assertThat(testCustomer.getCountryId()).isEqualTo(UPDATED_COUNTRY_ID);
        ...
        assertThat(testCustomer.getTradeLicense()).isEqualTo(UPDATED_TRADE_LICENSE);
    }
    ...
    void partialUpdateCustomerWithPatch() throws Exception {
        ...
        partialUpdatedCustomer.nationalId(UPDATED_NATIONAL_ID).address(UPDATED_ADDRESS);
