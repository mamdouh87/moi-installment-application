...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './request-system-fee.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_REQUESTSYSTEMFEE_LIST actions', async () => {
    ...
    it('dispatches FETCH_REQUESTSYSTEMFEE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_REQUESTSYSTEMFEE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_REQUESTSYSTEMFEE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_REQUESTSYSTEMFEE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_REQUESTSYSTEMFEE actions', async () => {
      const expectedActions = [
        {
